...
(function () {
    ...
    var TRANSLATIONS = {
        en: {
            ...
            detailEducation: '"Computer Science, METU (2013-2016, incomplete)"',
            detailLanguages: '["Turkish (Native)", "English (Proficient)"]',
            detailAward: '"e-biko 7th International ICT Olympiad, Ankara 2011"',

            // Achievements
            ach1Title: 'Core Systems Rebuilt',
            ach1Desc: 'Led the rebuild of trading systems at GoldenBull, 60% faster load times',
            ach2Title: 'Token Launch Shipped',
            ach2Desc: 'Wallet, exchange and sportsbook delivered for the AceD token',
            ach3Title: '97% Faster',
            ...
            expFh1: 'Managed a portfolio of 4 payment projects',
            ...
            expFh7: 'Integrated the SWIFT network for international transactions',
            ...
            expAc2: 'Drove token sales through technical delivery and customer relations',
            expAc3: 'Migrated masternode standards to BEP20 & ERC20',
            expAc4: 'Managed a team of 5 developers across 5+ concurrent projects',
            expAl1: 'Directed redevelopment of core systems using .NET Core & Python Flask',
            expAl2: 'Owned the revamp from architecture to rollout',
        ...
        tr: {
            ...
            detailEducation: '"Bilgisayar Bilimleri, ODTÜ (2013-2016, tamamlanmadı)"',
            detailLanguages: '["Türkçe (Ana Dil)", "İngilizce (İleri Düzey)"]',
            detailAward: '"e-biko 7. Uluslararası Bilişim Olimpiyatı, Ankara 2011"',

            ach1Title: 'Çekirdek Sistemler Yenilendi',
            ach1Desc: 'GoldenBull\'da işlem sistemlerinin yeniden inşasını yönettim, %60 daha hızlı yükleme',
            ach2Title: 'Token Lansmanı Teslim Edildi',
            ach2Desc: 'AceD token için cüzdan, borsa ve sportsbook teslim edildi',
            ...
            expFh1: '4 ödeme projesinden oluşan portföyü yönettim',
            ...
            expFh7: 'Uluslararası işlemler için SWIFT ağını entegre ettim',
            ...
            expAc2: 'Teknik teslimat ve müşteri ilişkileriyle token satışlarını sürükledim',
            expAc3: 'Masternode standartlarını BEP20 ve ERC20\'ye taşıdım',
            expAc4: '5 kişilik ekibi 5+ eşzamanlı projede yönettim',
            expAl1: '.NET Core ve Python Flask ile çekirdek sistemlerin yeniden geliştirmesini yönettim',
            expAl2: 'Yenilemeyi mimariden canlıya almaya kadar sahiplendim',
        ...
        es: {
            ...
            detailEducation: '"Ciencias de la Computación, METU (2013-2016, incompleta)"',
            detailLanguages: '["Turco (Nativo)", "Inglés (Competente)"]',
            detailAward: '"e-biko 7ª Olimpiada Internacional de TIC, Ankara 2011"',

            ach1Title: 'Sistemas Core Reconstruidos',
            ach1Desc: 'Lideré la reconstrucción de los sistemas de trading en GoldenBull, 60% más rápido',
            ach2Title: 'Lanzamiento de Token Entregado',
            ach2Desc: 'Billetera, exchange y sportsbook entregados para el token AceD',
            ...
            expFh1: 'Gestioné un portafolio de 4 proyectos de pagos',
            ...
            expFh7: 'Integré la red SWIFT para transacciones internacionales',
            ...
            expAc2: 'Impulsé las ventas de tokens con entrega técnica y relación con clientes',
            expAc3: 'Migré estándares de masternode a BEP20 y ERC20',
            expAc4: 'Gestioné un equipo de 5 desarrolladores en 5+ proyectos simultáneos',
            expAl1: 'Dirigí rediseño de sistemas core usando .NET Core y Python Flask',
            expAl2: 'Lideré la renovación desde la arquitectura hasta el despliegue',
