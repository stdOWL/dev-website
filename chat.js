...
## Core Identity
Name: Osman Ozturk. Born in Turkey. Studied Computer Science at Middle East Technical University (METU) 2013-2016, did not complete the degree — self-taught, shipping production systems since 2010. Based in London, UK. Turkish (native), English (fluent).
...
function getFallbackResponse(input) {
    ...
    if (q.includes('turkey') || q.includes('turkish') || q.includes('london') || q.includes('where')) {
        return "Born and raised in Turkey, study Computer Science at METU in Ankara (2013 to 2016, didn't finish — I learned most of what I know shipping real systems since I was 15). Worked across Thailand, Canada, and Turkey before settling in London. Every city taught me something different about building software for different markets.";
    }
